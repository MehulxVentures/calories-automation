        ...
        <form className={cn("flex flex-col gap-4", className)} {...props}>
            <FieldGroup className="gap-4">
                ...
                <div className="flex flex-col gap-2">
                    <Field>
                        <Input id="name" type="name" placeholder="Name" required className="h-11 rounded-3xl px-4 text-[13px]" onChange={(e) => setName(e.target.value)} />
                    </Field>
            ...
            <div className="text-center mt-6">
                <Link href="/sign-in" className="text-[12px] text-muted-foreground font-medium hover:text-foreground transition-colors underline-offset-4 hover:underline">
                    Already have an Accout? Login and get started.
                </Link>
            </div>
        </form>
    )
